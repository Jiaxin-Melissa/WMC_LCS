...
desired_order <- c(
    ...
    "b_bVSc:trial_order", 
    "b_trial_order:cVSd",
    "b_ConsonantsAccuracy:bVSc:trial_order",  
...
ggsave("posterior_distributions_all_fixed_effects_maze_accuracy.png", combined_all_fixed_plot, width = 16, height = 16, dpi = 300)
